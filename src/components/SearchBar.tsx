  ...
  return (
    ...
    <form onSubmit={handleSubmit} className={`relative ${className}`}>
      <input
        ...
        className={`${width} px-4 py-4 pl-16 pr-4 text-sm text-gray-900 dark:text-gray-100 bg-white dark:bg-[#222222] rounded-full focus:ring-2 focus:ring-teal-500 outline-none ${inputClassName}`}
      />
      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
          <div className="bg-green-100 dark:bg-[#222222] rounded-full p-2">
            <svg className={`h-5 w-5 text-black dark:text-gray-100 ${iconClassName}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
